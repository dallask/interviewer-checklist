...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/.gsd-surface.json`
(sibling to `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/dallask/Projects/dallask/interviewer-checklist/.claude/skills`).
...
`/Users/dallask/Projects/dallask/interviewer-checklist/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/.gsd-surface.json`
Install profile marker: `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/.gsd-profile`
Skill dirs: `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/skills/gsd-*/`
Engine module: `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
