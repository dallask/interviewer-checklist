...
The keys live in `.claude/settings.json` (project) or `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/settings.json` (global) — **not** in `.planning/config.json`:
