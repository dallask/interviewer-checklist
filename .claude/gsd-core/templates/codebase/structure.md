...
- Usage: Reference from command with `@/Users/dallask/Projects/dallask/interviewer-checklist/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/dallask/Projects/dallask/interviewer-checklist/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/dallask/Projects/dallask/interviewer-checklist/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
