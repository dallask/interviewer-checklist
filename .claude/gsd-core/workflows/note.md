...
- **Global scope**: `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/notes/`)
...
2. Glob `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/dallask/Projects/dallask/interviewer-checklist/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/notes/` — works in any directory
