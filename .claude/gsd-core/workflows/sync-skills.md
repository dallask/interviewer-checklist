...
INSTALL_JS_GLOBAL="/Users/dallask/Projects/dallask/interviewer-checklist/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/dallask/Projects/dallask/interviewer-checklist/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
