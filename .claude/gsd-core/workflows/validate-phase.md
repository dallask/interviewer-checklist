...
```
Agent(
  prompt="Read /Users/dallask/Projects/dallask/interviewer-checklist/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/dallask/Projects/dallask/interviewer-checklist/.claude/gsd-core/templates/VALIDATION.md`
