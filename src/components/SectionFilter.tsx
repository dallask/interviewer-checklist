  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        ...
        className={`w-full flex items-center px-3 py-1.5 text-[13px] text-left text-gray-900 dark:text-gray-100 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none ${
